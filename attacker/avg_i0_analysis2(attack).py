...
# 讀取日誌資料
with open('/Users/yq/Documents/analysis/avg-i0_attack.py', 'r', encoding='utf-8') as file: #Users/yq/Documents/analysis/avg-i0_normal.py'
    log_data = file.read()
...
# 儲存圖表
plt.savefig('/Users/yq/Documents/analysis/attacker/avg_i0_analysis2(attack).png', dpi=300, bbox_inches='tight')
print(f"\n圖表已儲存為: avg_i0_analysis2(attack).png")
...
# 儲存第二個圖表
plt.savefig('/Users/yq/Documents/analysis/attacker/avg_i0_detailed_analysis2(attack).png', dpi=300, bbox_inches='tight')
print(f"詳細分析圖表已儲存為: avg_i0_detailed_analysis2(attack).png")
